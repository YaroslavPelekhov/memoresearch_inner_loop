...
def extract_behavior_keys_from_behavior_space(
    behavior_space: BehaviorSpace | DynamicBehaviorSpace,
    island_configs: Any | None = None,
) -> set[str]:
    """Extract behavior keys from a single behavior space."""
    return set(behavior_space.behavior_keys)
