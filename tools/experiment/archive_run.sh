...
gigaevo -r "$RUN_SPEC" export csv -o "$ARCHIVE_DIR/evolution_data.csv"
...
gigaevo -r "$RUN_SPEC" top -n 9999 --save-dir "$ARCHIVE_DIR/programs"
...
gigaevo -f json -r "$RUN_SPEC" top -n 50 > "$ARCHIVE_DIR/top50.json"
