...
class EvalGauntlet(Callback):
    ...
    def eval_standalone_end(self, state: State, logger: Logger) -> dict[str, float]:
        return self.eval_after_all(state, logger)