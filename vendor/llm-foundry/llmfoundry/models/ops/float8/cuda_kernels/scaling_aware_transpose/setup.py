"""Build script for the scaling_aware_transpose CUDA extension.
...
Environment
-----------
    TORCH_CUDA_ARCH_LIST="8.0 9.0"   – compile for specific SM architectures.
    Leave unset to compile for the current machine's GPU (``-arch=native``).
"""
...
setup(
    name="scaling_aware_transpose_cuda",
    ext_modules=[
        CUDAExtension(
