...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--limit-samples", type=int, required=False, default=None)
    parser.add_argument("--no_wrap", default=False, action="store_true")
    parser.add_argument("--tokens_dtype", type=str, default="uint16", required=True)
...
def build_hf_dataset(
    ...
    Args:
        ...
        limit_samples (Optional[int]): An optional # of samples to stop at.
    ...
    hf_dataset = hf_datasets.load_dataset(
        "parquet", data_files=data_files, split=split, streaming=True
    )
...
def main(args: Namespace) -> None:
    """Process dataset based on the provided args.
    ...
    if args.concat_tokens is not None:
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            args.tokenizer, add_bos_token=True, add_eos_token=True
        )
